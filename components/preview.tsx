...
export default function Preview (props: PreviewProps) {
    return (
        <div id="preview" className="flex flex-col justify-between gap-4 w-[874px] h-[1240px] bg-light text-dark">
            ...
            <input type="text" id="mocName" placeholder="MOC title" className={ "mx-auto w-4/5 text-6xl text-center uppercase " + robotoBold.className}></input> 

            <div className="h-1 mx-auto w-4/5 bg-brand"/>
             
            <textarea className={"grow mx-auto w-4/5 text-4xl resize-none " + roboto.className} id="mocDescription" name="mocDescription" placeholder={ loremIpsum }/>
