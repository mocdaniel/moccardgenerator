        ...
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white py-2 px-4 rounded-lg">
            ...
            <p className="text-2xl">
              This browser doesn&apos;t seem to be Chrome-based
            </p>
            <p className="text-xl pt-4">
              As this can lead to severe problems with generating the final PDF,
              <br />
              we decided to postpone support for browsers like{" "}
              <b>
                Safari, Firefox,
                <br />
              ...
              <ul className="list-disc pl-6">
                ...
                <li>
                  <a
                    className="underline"
                    href="https://www.microsoft.com/de-de/edge/download"
                  >
                    Microsoft Edge
                  </a>
                </li>
                <li>
                  <a
                    className="underline"
                    href="https://brave.com/de/download/"
                  >
                    Brave
                  </a>
                </li>
